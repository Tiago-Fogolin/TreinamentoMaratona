...
Tradução do exercício do codeforces:
# C. Hambúrgueres
...
A segunda linha contém três inteiros `nb`, `ns`, `nc` (1 ≤ `nb`, `ns`, `nc` ≤ 100) — o número de pedaços de pão, salsicha e queijo na cozinha de Polycarpus. A terceira linha contém três inteiros `pb`, `ps`, `pc` (1 ≤ `pb`, `ps`, `pc` ≤ 100) — o preço de um pedaço de pão, salsicha e queijo na loja. Finalmente, a quarta linha contém o inteiro `r` (1 ≤ `r` ≤ 10¹²) — o número de rublos que Polycarpus tem.

Por favor, não escreva o especificador `%lld` para ler ou escrever inteiros de 64 bits em C++. É preferível usar os fluxos `cin`, `cout` ou o especificador `%I64d`.
